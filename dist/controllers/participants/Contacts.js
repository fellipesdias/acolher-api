...
exports.Contacts = {
    create: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var contact, newContacts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    contact = req.body;
                    return [4 /*yield*/, server_1.prismaClient.contatos.createMany({
                            data: contact,
                            skipDuplicates: true,
                        })];
                case 1:
                    newContacts = _a.sent();
                    return [2 /*return*/, res.status(201).json(newContacts)];
            }
        });
    }); },
    find: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var participantId, contactList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    participantId = req.params.participantId;
                    return [4 /*yield*/, server_1.prismaClient.contatos.findMany({
                            where: {
                ...
                case 1:
                    contactList = _a.sent();
                    return [2 /*return*/, res.json(contactList)];
            }
        });
    }); },
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                    return [4 /*yield*/, server_1.prismaClient.contatos.delete({
                            where: {
                                id: Number(id),
                            },
                        })];
