...
exports.FamilyData = void 0;
var server_1 = require("../../server");
exports.FamilyData = {
    create: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var familyData, familyDataCreated;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    familyData = req.body;
                    return [4 /*yield*/, server_1.prismaClient.dadosFamiliares.create({
                            data: familyData,
                        })];
                case 1:
                    familyDataCreated = _a.sent();
                    return [2 /*return*/, res.json(familyDataCreated)];
            }
        });
    }); },
    find: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var idParticipant, familyData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    familyData = _a.sent();
                    if (familyData) {
                        return [2 /*return*/, res.json(familyData)];
                    }
    ...
    update: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    familyData = req.body;
                    return [4 /*yield*/, server_1.prismaClient.dadosFamiliares.update({
                            where: {
                                id: familyData.id,
                            },
                            data: familyData,
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params;
                    return [4 /*yield*/, server_1.prismaClient.dadosFamiliares.delete({
                            where: {
                                id: Number(id),
                            },
                        })];
