...
exports.AuthController = {
    login: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, usuario, senha, user;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, usuario = _a.usuario, senha = _a.senha;
                    if (!(usuario && senha)) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    if (user) {
                        ...
                        return [2 /*return*/, res.status(401).json({ mensagem: "credenciais inválidas." })];
                    }
                    _b.label = 2;
    ...
    signup: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, usuario, senha, user, newUser;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, usuario = _a.usuario, senha = _a.senha;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, server_1.prismaClient.usuarios.create({
                            data: {
                                usuario: usuario,
                                senha: senha,
                            },
